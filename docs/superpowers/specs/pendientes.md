...
- **El costo del sondeo contra la base remota** es el insumo principal del bloque 1C-B, con la decisión concreta: que la web despierte al worker en vez de que él pregunte cada dos segundos.
