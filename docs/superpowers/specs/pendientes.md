...
- **`AUTH_TRUST_HOST` no está configurado.** No rompe nada hoy —Auth.js falla cerrado sin él— pero el middleware lo convierte en algo que se evalúa en cada petición a una página, no solo en las escrituras que pasan por `ejecutar`.
