...
- **El proyecto desechable de Vercel de la prueba de humo del conector sigue existiendo, con la clave privada de la cuenta de servicio cargada en sus variables de entorno.** Se pensó desechable y el plan de despliegue decía borrarlo al terminar, pero no se borró (ver `CLAUDE.md`). Es material sensible vivo: hay que borrar el proyecto — o, como mínimo, rotar la clave de la cuenta de servicio en Google Cloud y quitarla de ahí — antes de que quede olvidado.
